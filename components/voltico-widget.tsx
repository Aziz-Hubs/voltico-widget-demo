...
/* === Trigger button: simple indigo orb — one soft highlight, clean lift ===
   The widget wraps the trigger in a circular iframe (border-radius:100%), so the
   button is a clean circle and effects stay inside it. === */
[data-component='trigger/btn'] {
  border-radius: 50% !important;
  background:
    radial-gradient(circle at 30% 24%, rgba(255,255,255,0.30), rgba(255,255,255,0) 55%),
